    ...
    try:
        ...
        while True:
            try:
                ...
                # 데이터 삽입
                print("Inserting data:", (temperature, humidity, pressure, wind_direction, wind_speed, rainfall, dust))
                insert_data(conn, (temperature, humidity, pressure, wind_direction, wind_speed, rainfall, dust))
